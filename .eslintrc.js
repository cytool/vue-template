module.exports = {
    ...
    rules: {
        ...
        "object-curly-newline": ["error", { // 有{}的对象是否需要换行
            "ObjectExpression": { "multiline": true, "minProperties": 3 }, // 对象字面量
            "ObjectPattern": { "multiline": true, "minProperties": 3 }, // 解构赋值
            "ImportDeclaration": "never", // import
            "ExportDeclaration": { "multiline": true, "minProperties": 3 } // export
        }], // 大括号与内容要换行
        ...
        /* ------------- 正则 -------------*/
        "require-unicode-regexp": "error", // 正则必须要有 u 标志， 匹配emoji、unicode
        ...
        "padding-line-between-statements": ["error", {
            ...
            { blankLine: "always", prev: ["const", "let", "var"], next: "*" }, { blankLine: "never", prev: ["const", "let", "var"], next: ["const", "let", "var"] }, { blankLine: "always", prev: ["const", "let", "var"], next: ["block-like"] }, { blankLine: "always", prev: "expression", next: ["const", "let", "var"] }], // 是否要空白换行

        "no-trailing-spaces": ["error", { "skipBlankLines": true }], // 空行允许使用空白符(比如回车下来的)
        "space-before-blocks": ["error", { "functions": "always", "keywords": "always", "classes": "always" }], // 块{}之前要有空格,
